...
mod tests {
    ...
    async fn test_register_and_call_tool() {
        ...
        registry
            .register_tool("test_topic", def, create_test_handler())
            .await
    ...
    async fn test_validate_args_success() {
        ...
        // Valid args
        let result = registry
            .call_tool("test_topic__test_tool", json!({ "count": 5 }))
            .await;
    ...
    async fn test_validate_args_failure() {
        ...
        let result = registry
            .call_tool("test_topic__test_tool", json!({ "count": -1 }))
            .await;
    ...
    async fn test_tool_not_found() {
        ...
        let result = registry.call_tool("nonexistent__tool", json!({})).await;
